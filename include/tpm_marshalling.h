...
static int tpm_marshal_BYTE(BYTE **ptr, UINT32 *length, BYTE v)
{
...
static int tpm_unmarshal_BYTE(BYTE **ptr, UINT32 *length, BYTE *v)
{
  if (*length < 1) return -1;
  *v = **ptr;
  *ptr += 1; *length -= 1;
...
static int tpm_marshal_UINT16(BYTE **ptr, UINT32 *length, UINT16 v)
{
...
static int tpm_unmarshal_UINT16(BYTE **ptr, UINT32 *length, UINT16 *v)
{
  if (*length < 2) return -1;
...
static int tpm_marshal_UINT32(BYTE **ptr, UINT32 *length, UINT32 v)
{
...
static int tpm_unmarshal_UINT32(BYTE **ptr, UINT32 *length, UINT32 *v)
{
  if (*length < 4) return -1;
...
static int tpm_marshal_BLOB(BYTE **ptr, UINT32 *ptr_length,
...
static int tpm_unmarshal_BLOB(BYTE **ptr, UINT32 *ptr_length,
                                     BYTE **b, UINT32 b_length)
{
  if (*ptr_length < b_length) return -1;
  *b = (b_length) ? *ptr : NULL;
...
static int tpm_marshal_BYTE_ARRAY(BYTE **ptr, UINT32 *ptr_length,
                                         BYTE *b, UINT32 b_length)
{
  if (*ptr_length < b_length) return -1;
...
static int tpm_unmarshal_BYTE_ARRAY(BYTE **ptr, UINT32 *ptr_length,
                                           BYTE *b, UINT32 b_length)
{
  if (*ptr_length < b_length) return -1;
...
static int tpm_marshal_BOOL(BYTE **ptr, UINT32 *length, BOOL v)
{
  if (*length < 1) return -1;
  **ptr = v & 0x01;
  *ptr += 1; *length -= 1;
...
static int tpm_unmarshal_BOOL(BYTE **ptr, UINT32 *length, BOOL *v)
{
