...
typedef struct
{
	...
	unsigned int    m_IsMother;          //母锁标志: 0x01表示是母锁, 0x00表示不是母锁
    unsigned int    m_DevType;           //设备类型(PROTOCOL_HID或者PROTOCOL_CCID)
...
typedef struct
{
	int           m_Count;        //可调次数: 0xFFFFFFFF表示不限制, 递减到0表示已不可调用
...
typedef struct
{
	unsigned int  m_Priv_Enc;   //加密时的调用权限: 0为最小匿名权限，1为最小用户权限，2为最小开发商权限
...
typedef struct
{
	unsigned int    m_Size;      //数据文件长度，该值最大为4096
	DATA_LIC         m_Lic;       //授权
...
typedef struct
{
	...
	unsigned int  m_UserID_Start;            //起始用户ID
...
typedef struct
{
	...
	unsigned int      m_Count;                //可产生子锁初始化数据的次数 (-1表示不限制次数, 递减到0时会受限)
 ...
 */
DWORD  Dongle_Enum(DONGLE_INFO * pDongleInfo, int * pCount);
 ...
 */
DWORD  Dongle_Open(DONGLE_HANDLE * phDongle, int nIndex);
 ...
 * @return DONGLE_SUCCESS       执行成功。
 */
DWORD  Dongle_ResetState(DONGLE_HANDLE hDongle);
 ...
 */
DWORD Dongle_Close(DONGLE_HANDLE hDongle);
 ...
 */
DWORD  Dongle_GenRandom(DONGLE_HANDLE hDongle, int nLen, BYTE * pRandom);
 ...
 */
DWORD  Dongle_LEDControl(DONGLE_HANDLE hDongle, int nFlag);
 ...
 * @return DONGLE_SUCCESS       执行成功。
 */
DWORD  Dongle_SwitchProtocol(DONGLE_HANDLE hDongle, int nFlag);
 ...
 * @return DONGLE_SUCCESS         执行成功。
 */
DWORD  Dongle_RFS(DONGLE_HANDLE hDongle);
 ...
 */
DWORD  Dongle_CreateFile(DONGLE_HANDLE hDongle, int nFileType, WORD wFileID, void * pFileAttr);
 ...
 */
DWORD  Dongle_WriteFile(DONGLE_HANDLE hDongle, int nFileType, WORD wFileID, WORD wOffset, BYTE * pInData, int nDataLen);
 ...
 */
DWORD  Dongle_ReadFile(DONGLE_HANDLE hDongle, WORD wFileID, WORD wOffset, BYTE * pOutData, int nDataLen);
 ...
 */
DWORD  Dongle_DownloadExeFile(DONGLE_HANDLE hDongle, EXE_FILE_INFO * pExeFileInfo, int nCount);
 ...
 */
DWORD  Dongle_RunExeFile(DONGLE_HANDLE hDongle, WORD wFileID, BYTE * pInOutBuf, WORD wInOutBufLen, int * pMainRet);
 ...
 */
DWORD  Dongle_DeleteFile(DONGLE_HANDLE hDongle, int nFileType, WORD wFileID);
 ...
 */
DWORD  Dongle_ListFile(DONGLE_HANDLE hDongle, int nFileType, void* pFileList, int * pDataLen);
 ...
 */
DWORD  Dongle_GenUniqueKey(DONGLE_HANDLE hDongle,int nSeedLen, BYTE * pSeed, char * pPIDstr, char * pAdminPINstr);
 ...
 */
DWORD  Dongle_VerifyPIN(DONGLE_HANDLE hDongle, int nFlags, char * pPIN, int * pRemainCount);
 ...
 */
DWORD Dongle_ChangePIN(DONGLE_HANDLE hDongle, int nFlags, char * pOldPIN, char * pNewPIN, int nTryCount);
 ...
 */
DWORD  Dongle_ResetUserPIN(DONGLE_HANDLE hDongle, char * pAdminPIN);
 ...
 * @return DONGLE_SUCCESS        重置用户PIN码成功。
 */
DWORD  Dongle_SetUserID(DONGLE_HANDLE hDongle, DWORD dwUserID);
 ...
 */
DWORD  Dongle_GetDeadline(DONGLE_HANDLE hDongle, DWORD * pdwTime);
 ...
 */
DWORD Dongle_SetDeadline(DONGLE_HANDLE hDongle, DWORD dwTime);
 ...
 * @return DONGLE_SUCCESS       设置加密锁到期时间成功。
 */
DWORD  Dongle_GetUTCTime(DONGLE_HANDLE hDongle, DWORD * pdwUTCTime);
 ...
 */
DWORD  Dongle_ReadData(DONGLE_HANDLE hDongle, int nOffset, BYTE* pData, int nDataLen);
 ...
 */
DWORD  Dongle_WriteData(DONGLE_HANDLE hDongle, int nOffset, BYTE * pData, int nDataLen);
 ...
 */
DWORD Dongle_ReadShareMemory(DONGLE_HANDLE hDongle, BYTE * pData);
 ...
 */
DWORD  Dongle_WriteShareMemory(DONGLE_HANDLE hDongle, BYTE * pData, int nDataLen);
 ...
 */
DWORD  Dongle_RsaGenPubPriKey(DONGLE_HANDLE hDongle, WORD wPriFileID, RSA_PUBLIC_KEY * pPubBakup, RSA_PRIVATE_KEY * pPriBakup);
 ...
 */
DWORD  Dongle_RsaPri(DONGLE_HANDLE hDongle, WORD wPriFileID, int nFlag, BYTE * pInData, int nInDataLen, BYTE * pOutData, int * pOutDataLen);
 ...
 */
DWORD  Dongle_RsaPub(DONGLE_HANDLE hDongle, int nFlag, RSA_PUBLIC_KEY * pPubKey, BYTE * pInData, int nInDataLen, BYTE * pOutData, int * pOutDataLen);
 ...
 */
DWORD  Dongle_EccGenPubPriKey(DONGLE_HANDLE hDongle, WORD wPriFileID, ECCSM2_PUBLIC_KEY * pPubBakup, ECCSM2_PRIVATE_KEY * pPriBakup);
 ...
 */
DWORD  Dongle_EccSign(DONGLE_HANDLE hDongle, WORD wPriFileID, BYTE * pHashData, int nHashDataLen, BYTE * pOutData);
 ...
 */
DWORD  Dongle_EccVerify(DONGLE_HANDLE hDongle, ECCSM2_PUBLIC_KEY * pPubKey, BYTE * pHashData, int nHashDataLen, BYTE * pSign);
 ...
 * @return DONGLE_SUCCESS           产生ECC公私钥成功。 
 */
DWORD  Dongle_SM2GenPubPriKey(DONGLE_HANDLE hDongle, WORD wPriFileID, ECCSM2_PUBLIC_KEY * pPubBakup, ECCSM2_PRIVATE_KEY * pPriBakup);
 ...
 * @return DONGLE_SUCCESS             表示签名成功。
 */
DWORD  Dongle_SM2Sign(DONGLE_HANDLE hDongle, WORD wPriFileID, BYTE * pHashData, int nHashDataLen, BYTE * pOutData);
 ...
 * @return DONGLE_SUCCESS             表示验签成功,否则表示验签失败。
 */
DWORD  Dongle_SM2Verify(DONGLE_HANDLE hDongle, ECCSM2_PUBLIC_KEY * pPubKey, BYTE * pHashData, int nHashDataLen, BYTE * pSign);
 ...
 */
DWORD  Dongle_TDES(DONGLE_HANDLE hDongle, WORD wKeyFileID, int nFlag, BYTE * pInData, BYTE * pOutData, int nDataLen);
 ...
 */
DWORD  Dongle_SM4(DONGLE_HANDLE hDongle, WORD wKeyFileID, int nFlag, BYTE * pInData, BYTE * pOutData, int nDataLen);
 ...
 */
DWORD  Dongle_HASH(DONGLE_HANDLE hDongle, int nFlag, BYTE * pInData, int nDataLen, BYTE * pHash);
 ...
 */
DWORD  Dongle_Seed(DONGLE_HANDLE hDongle, BYTE * pSeed, int nSeedLen, BYTE * pOutData);
 ...
 */
DWORD  Dongle_LimitSeedCount(DONGLE_HANDLE hDongle, int nCount);
 ...
 */
DWORD  Dongle_GenMotherKey(DONGLE_HANDLE hDongle, MOTHER_DATA * pInData);
 ...
 */
DWORD  Dongle_RequestInit(DONGLE_HANDLE hDongle, BYTE * pRequest);
 ...
 */
DWORD  Dongle_GetInitDataFromMother(DONGLE_HANDLE hDongle, BYTE * pRequest, BYTE * pInitData, int * pDataLen);
 ...
 */
DWORD  Dongle_InitSon(DONGLE_HANDLE hDongle, BYTE * pInitData, int nDataLen);
 ...
 */
DWORD  Dongle_SetUpdatePriKey(DONGLE_HANDLE hDongle, RSA_PRIVATE_KEY * pPriKey);
 ...
 */
DWORD  Dongle_MakeUpdatePacket(DONGLE_HANDLE hDongle, char * pHID, int nFunc, int nFileType, WORD wFileID, int nOffset, BYTE * pBuffer, int nBufferLen, RSA_PUBLIC_KEY * pUPubKey, BYTE * pOutData, int * pOutDataLen);
 ...
 * @return DONGLE_SUCCESS               制作升级包成功。
 */
DWORD  Dongle_MakeUpdatePacketFromMother(DONGLE_HANDLE hDongle, char * pHID, int nFunc, int nFileType, WORD wFileID, int nOffset, BYTE * pBuffer, int nBufferLen, BYTE * pOutData, int * pOutDataLen);
 ...
 */
DWORD  Dongle_Update(DONGLE_HANDLE hDongle, BYTE * pUpdateData, int nDataLen);
